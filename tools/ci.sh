...
#      457 with udp_share: the NetX Duo shared-socket multicast fan-out (#38)
#      458 with bind_share: bsd_bind's wildcard-only port-share opt-in (#38)
...
case "$(uname -m)" in
    ...
    # (8ff3cc92), all x86_64-only for the
