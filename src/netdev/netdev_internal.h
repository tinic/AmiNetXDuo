 ...
 * IOSana2Req, as they always have, and SANA-II callers that leave mn_Length
 * unset depend on it.  The NewStyle query alone takes mn_Length 0 as an
 * IOStdReq (#64); see netdev_nsd_query().
 */
