...
{
    /* name        manid prodid reg_off stride wide_off irq_off kind
       chip                bps         ax  mem_off mem_size prom_off */
    { "xsurf100",  4626,   100, 0x0800,     4, 0x8880,   0x40, NETDEV_IRQ_BIT7,
      NETDEV_CHIP_NE2000, 100000000UL, 1,       0,       0,       0 },

    { "xsurf",     4626,    23, 0x8600,     2,      0,   0x40, NETDEV_IRQ_BIT7,
      NETDEV_CHIP_NE2000,  10000000UL, 0,       0,       0,       0 },

    { "ariadne2",  2167,   202, 0x0600,     2,      0,      0, NETDEV_IRQ_NONE,
      NETDEV_CHIP_NE2000,  10000000UL, 0,       0,       0,       0 },

    { "hydra",     2121,     1, 0xffe1,     2,      0,      0, NETDEV_IRQ_NONE,
      NETDEV_CHIP_ED,      10000000UL, 0,       0,  0x4000,  0xffc0 },

    { "lanrover",  1023,   254, 0x0001,     2,      0,      0, NETDEV_IRQ_NONE,
