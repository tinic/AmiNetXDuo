                          ...
                          const AmiRxSum *sum)
{
    ...
    case AMI_ETHERTYPE_IPV4:
         ...
         */
        {
             ...
             * A frame that did not sum (misaligned, or no sum at all) passes
 ...
 * interrupt level and the device may complete this read before the store that
 * armed it would otherwise have landed.
 */
