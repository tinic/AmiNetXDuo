...
/*
 * A stamp at or above this is wall-clock seconds; below it, seconds since
 * boot on a machine with no clock.  The two cannot be compared with each
 * other, and this is what tells them apart.
 */
 ...
 *
 * Both sides have to be the same kind of stamp for the subtraction to mean
 ...
 * which costs one full handshake and is what would have happened anyway.
 *
