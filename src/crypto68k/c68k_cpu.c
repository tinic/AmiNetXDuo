...
/* The four X25519 field routines are set where their portable twins are,
   inside c68k_25519.c, because they are static there. */
...
VOID c68k_cpu_select(ULONG attnflags)
{
     ...
     * That is the one case here where a wrong answer is slow rather than only
     * slower, and user mode cannot tell it apart from a real 68040.
     */
