 ...
 * chain, weakest last, is an interface file's ID= and then ENV:HOSTNAME;
 * AmiHostnameSource in aminetxduo/config.h says why in that order. DHCP option
 * 12 sits between them and arrives later, once there is a lease.
 *
