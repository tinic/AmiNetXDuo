...
const APTR BsdVectorTable[] =
{
    ...
    (APTR)bsd_enosys,             /* -0x090 [ 23] ObtainSocket */
    (APTR)bsd_enosys,             /* -0x096 [ 24] ReleaseSocket */
    (APTR)bsd_enosys,             /* -0x09c [ 25] ReleaseCopyOfSocket */
    ...
    (APTR)bsd_enosys,             /* -0x114 [ 45] recvmsg */
