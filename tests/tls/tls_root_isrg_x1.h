...
#ifndef AMINETXDUO_TLS_ROOT_ISRG_X1_H
#define AMINETXDUO_TLS_ROOT_ISRG_X1_H

static const unsigned char isrg_root_x1_der[] =
{
...
#define isrg_root_x1_der_len    ((unsigned short)sizeof(isrg_root_x1_der))

#endif /* AMINETXDUO_TLS_ROOT_ISRG_X1_H */
