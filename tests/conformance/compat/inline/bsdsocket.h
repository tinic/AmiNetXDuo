 ...
 * rejects outright:
 *
 *   error: 'asm' specifier for variable '__SetErrnoPtr_errno_ptr'
 ...
 *
 *   fd2pragma --infile bsdsocket_lib.fd --clib clib/bsdsocket_protos.h \
 *             --special 40
 *
 * The FD covers socket() .. ObtainServerSocket() (0x01e..0x2b8), which is
 * every vector bsdsocktest calls; the Roadshow tail (getaddrinfo and friends,
 * 0x2be..0x336) is absent and would have to be added by hand if a future test
 * needs it.
 *
 * Nothing here is AmiNetXDuo-specific: it is a pure ABI header, and putting
 * tests/conformance/compat first on the include path is the only change.
 *
 * Generated by fd2pragma 2.197; do not hand-edit.
 */
