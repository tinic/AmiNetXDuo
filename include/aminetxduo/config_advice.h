...
#define AMI_CFG_SAYS_NAMESERVER_IN_AN_INTERFACE          45
#define AMI_CFG_ADVICE_PUT_IT_IN_NAME_RESOLUTION         46
#define AMI_CFG_ADVICE_IPREQUESTS_AND_ARPREQUESTS_ARE    47
