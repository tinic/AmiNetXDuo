 ...
 * physical A1200/3C589 case measured the port drain at 7.7% of the complete
 * sampled run and the staging-to-packet copy/checksum at another 6.9%.  This
 * extension removes the latter and folds its checksum work into the former.
 * It is a bounded saving, not an explanation for the whole gap to another
 * stack.
 *
