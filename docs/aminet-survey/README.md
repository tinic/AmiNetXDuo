...
| of those, archives we ATTRIBUTED | 374 (66%) |
| attributed binaries | 833 |
...
sample.  What has NOT changed is the attribution rate: 66% of the archives
...
| limit | consequence |
|---|---|
| attribution 66% | "no observed caller" means no caller in the RESOLVED archives; the corpus itself is complete |
