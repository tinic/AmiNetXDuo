...
| The DHCP restart's re-arm path has no test | ALREADY_STARTED never arises in the SLIRP arm, so the stop-and-start-again is unexercised | `src/netstack/netstack.c:2683` |
