...
| `__muldi3` is 1.65x slower than libgcc's on a 68000 | 1719 ms against 1043 for 5000 multiplies, measured on an A600 under Amiberry; untouched by the divide work and unchanged by it | `src/common/ami_udivdi3.c` |
