...
| The IP-thread recv completer stays OFF: measured -1.4% | 3x3 poolshare div8, zero_windows matched 52/51: off 446.4 KB/s median, on 440.3; a price with no return | `src/bsdsocket/rxdirect.c:32` |
